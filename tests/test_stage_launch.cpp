...
void test_stage_vertical () {
    ...
    std::unique_ptr stage = Stage::create_stage(10.0,0.3,10,engine, tank, earth , 70 * m , 500 * m2); // a_wet -- random 
...
void test_stage_orbital()
{
    ...
    Engine engine {earth.surfacePoint(5.0),10000.0,1500000.0, 547.0};
    Tank tank {earth.surfacePoint(10.0), 5000.0,40000.0};
    std::unique_ptr stage = Stage::create_stage(10.0,0.3,10.0,engine, tank, earth , 70 * m, 500 * m2); // a_wet -- random );
